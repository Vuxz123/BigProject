...
public class AnimatedChannelProvider {
    ...
    public final AnimationChannel BOOM = new AnimationChannel(texture.BOOM.getImage(), Duration.millis(200), 7);
    ...
    class ATex {
        ...
        public final Texture BOOM = FXGL.getAssetLoader().loadTexture("entity/boom.png", 112, 32);
